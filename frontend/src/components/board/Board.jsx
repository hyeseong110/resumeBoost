        ...
        <div className="left">
          <div className="left-con">
            ...
            <div className="button">
              <button><Link to="/board/write">게시글 작성</Link></button>
            </div>
          </div>
        </div>
        ...
        <div className="right">
          <div className="right-top">
            <div className="right-top-con">
              <div onClick={() => handleCategoryChange('all')} className={category === 'all' ? 'active' : ''}>
                전체
              </div>
              <div onClick={() => handleCategoryChange('freedom')} className={category === 'freedom' ? 'active' : ''}>
                자유게시판
              </div>
              <div onClick={() => handleCategoryChange('letter')} className={category === 'letter' ? 'active' : ''}>
                자기소개서
              </div>
              <div onClick={() => handleCategoryChange('resume')} className={category === 'resume' ? 'active' : ''}>
                이력서
              </div>
              <div onClick={() => handleCategoryChange('interview')} className={category === 'interview' ? 'active' : ''}>
                면접
              </div>
            </div>
            ...
            <div key={post.id} className="post" onClick={() => navigate(`/board/detail/${post.id}`)}>
              ...
              <div className="post-footer">
                <div className="post-footer-left">
                  ...
                  <span className="post-time">{formatRelativeTime(post.createdTime)}</span>
                </div>
                <div className="post-footer-right">
                  <span>조회 {post.viewCount}</span> | <span>💬 {post.replyCount}</span>
                </div>
              </div>
            </div>
              ))
